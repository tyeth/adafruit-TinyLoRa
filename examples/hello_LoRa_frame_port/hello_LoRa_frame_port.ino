...
// Added Frame Port by clavisound, Aug 2019
/************************** Configuration ***********************************/
#include <TinyLoRa.h>
#include <SPI.h>
...
// In which port we send data? [TTN supports 0-255]
uint8_t framePort = 1;
...
void loop()
{
  ...
  lora.sendData(loraData, sizeof(loraData), lora.frameCounter, framePort); // If you ommit FramePort it's assumed #1
